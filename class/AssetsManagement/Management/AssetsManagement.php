<?php
namespace org\opencomb\openoa\AssetsManagement\Management;
 ...
 * 成本对比分析
 * */
class AssetsManagement extends OpenOaController{
	public $arrConfig = array (
			'title' => '资产登记',
			'view' => array (
					'template' => 'AssetsManagement/Management/AssetsManagement.html',
					'widgets'=>array(
					)
			),
// 			'perms' => array (
